...
const S = {
  ...
  tab_records: ['RECORDS', 'RECORD', 'RÉCORDS', 'RECORDS', 'REKORDE', 'RECORDES', 'РЕКОРДЫ', 'REKORDY'],
  rec_best: ['Best distance', 'Distanza record', 'Distancia récord', 'Meilleure distance', 'Beste Distanz', 'Melhor distância', 'Лучшая дистанция', 'Najlepszy dystans'],
  rec_time: ['Longest run', 'Run più lunga', 'Partida más larga', 'Partie la plus longue', 'Längster Lauf', 'Corrida mais longa', 'Самый долгий забег', 'Najdłuższy bieg'],
  rec_runs: ['Runs played', 'Partite giocate', 'Partidas jugadas', 'Parties jouées', 'Läufe gespielt', 'Partidas jogadas', 'Сыграно забегов', 'Rozegrane biegi'],
  rec_earned: ['Coins earned', 'Monete guadagnate', 'Monedas ganadas', 'Pièces gagnées', 'Verdiente Münzen', 'Moedas ganhas', 'Заработано монет', 'Zdobyte monety'],
  rec_daily: ['Daily best', 'Record del giorno', 'Récord diario', 'Record du jour', 'Tagesrekord', 'Recorde diário', 'Дневной рекорд', 'Dzienny rekord'],
  rec_rows: ['rows', 'righe', 'filas', 'rangs', 'Reihen', 'linhas', 'рядов', 'rzędów'],
  daily_bonus_title: ['🎁 DAILY BONUS', '🎁 BONUS GIORNALIERO', '🎁 BONO DIARIO', '🎁 BONUS DU JOUR', '🎁 TAGESBONUS', '🎁 BÔNUS DIÁRIO', '🎁 ЕЖЕДНЕВНЫЙ БОНУС', '🎁 DZIENNY BONUS'],
  daily_bonus_pick: ['Pick a bush!', 'Scegli un cespuglio!', '¡Elige un arbusto!', 'Choisis un buisson !', 'Wähle einen Busch!', 'Escolha um arbusto!', 'Выбери куст!', 'Wybierz krzak!'],
  daily_bonus_claim: ['🎁 DAILY BONUS', '🎁 BONUS GIORNALIERO', '🎁 BONO DIARIO', '🎁 BONUS DU JOUR', '🎁 TAGESBONUS', '🎁 BÔNUS DIÁRIO', '🎁 ЕЖЕДНЕВНЫЙ БОНУС', '🎁 DZIENNY BONUS'],
  db_coins: ['+{n} coins!', '+{n} monete!', '+{n} monedas!', '+{n} pièces !', '+{n} Münzen!', '+{n} moedas!', '+{n} монет!', '+{n} monet!'],
  db_shield: ['Free SHIELD next run!', 'SCUDO gratis alla prossima run!', '¡ESCUDO gratis la próxima partida!', 'BOUCLIER gratuit à la prochaine partie !', 'Gratis SCHILD nächste Runde!', 'ESCUDO grátis na próxima corrida!', 'Бесплатный ЩИТ в следующем забеге!', 'Darmowa TARCZA w następnym biegu!'],
  db_life: ['Free EXTRA LIFE next run!', 'VITA EXTRA gratis alla prossima run!', '¡VIDA EXTRA gratis la próxima partida!', 'VIE BONUS gratuite à la prochaine partie !', 'Gratis EXTRALEBEN nächste Runde!', 'VIDA EXTRA grátis na próxima corrida!', 'Бесплатная ДОП. ЖИЗНЬ в следующем забеге!', 'Darmowe DODATKOWE ŻYCIE w następnym biegu!'],
  db_acc: ['Unlocked accessory: {name}!', 'Accessorio sbloccato: {name}!', '¡Accesorio desbloqueado: {name}!', 'Accessoire débloqué : {name} !', 'Accessoire freigeschaltet: {name}!', 'Acessório desbloqueado: {name}!', 'Открыт аксессуар: {name}!', 'Odblokowano akcesorium: {name}!'],
  db_world: ['Unlocked world: {name}!', 'Mondo sbloccato: {name}!', '¡Mundo desbloqueado: {name}!', 'Monde débloqué : {name} !', 'Welt freigeschaltet: {name}!', 'Mundo desbloqueado: {name}!', 'Открыт мир: {name}!', 'Odblokowano świat: {name}!'],
