...
const S = {
  ...
  press_start: ['PRESS ANY KEY OR TAP TO START', 'PREMI UN TASTO O TOCCA PER INIZIARE', 'PULSA UNA TECLA O TOCA PARA EMPEZAR', 'APPUIE SUR UNE TOUCHE OU TAPOTE POUR COMMENCER', 'TASTE DRÜCKEN ODER TIPPEN ZUM STARTEN', 'PRESSIONE UMA TECLA OU TOQUE PARA COMEÇAR', 'НАЖМИ ЛЮБУЮ КЛАВИШУ ИЛИ КОСНИСЬ ЭКРАНА', 'NACIŚNIJ KLAWISZ LUB DOTKNIJ, BY ZACZĄĆ'],
